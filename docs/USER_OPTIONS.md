...
| `ice_switch`       | `bool` | `false` | Enable ice                                            |
...
| `ice_nucl`  | `bool` | `false` | Enable ice nucleation             |
| `depo`      | `bool` | `false` | Enable depositional growth of ice |
